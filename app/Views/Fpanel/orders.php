					...
					?>
							<div class="row text-white mt-1 mx-3" style="--bs-gutter-x:0px">
								<div class="col-12 col-md-10 p-3  bg-secondary">
									<div><b><?= RestoreTransformations($Order->userDetails["name"]); ?></b></div>
									<div><?= RestoreTransformations($Order->productDetails->name); ?> ( <?= $Order->productDetails->price; ?> ₺ )</div>
								</div>
								<div class="col-12 col-md-2 text-center bg-white" style="line-height: 80px;">
									<div class="dropdown">
										...
										<div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
											<?php
												$incomingId 	= RestoreTransformations($Order->id);
												$similarText	= "Fpanel/orders/";
												$dropDownItemList = [
						...
						?>
						<div class="p-5 border border-secondary">Kayıtlı sipariş bulunmamaktadır.</div>
					<?php
					}
					?>
				</div>
