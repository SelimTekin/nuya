					...
					?>
							<div class="row">
								...
								<div class="col-12 col-sm-10">
									<div class="row border border-secondary mt-2 shadow text-white p-2">
										<div class="col-12 col-md-10 p-3  bg-dark">
											...
											<div class="dropdown">
												...
												<div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
													<div class="dropdown-item mb-2 adminSettingsArea">
														<?php
															$incomingId 	= RestoreTransformations($Owner->userName);
															$similarText	= "Fpanel/log/";
															
															$dropDownItemList = [
																[$similarText . "loger/" . $incomingId, 		"goInLink adminDetailsColor", "fa-solid fa-highlighter", "Detay"],
															];
						...
						?>
						<div class="p-5 border border-secondary">Kayıtlı Kayıtçı bulunmamaktadır.</div>
					<?php
					}
					?>
				</div>
