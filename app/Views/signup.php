...
<body class="main-layout">
    ...
    <div class="layout_padding contact_section">
        <div class="container">
            <h1 class="new_text"><strong>Kayıt Ol</strong></h1>
        </div>
                        ...
                        <div class="input_main">
                            <div class="container">
                                <form action="signup" method="post">
                                    ...
                                    <div class="form-group">
                                        <input type="text" class="email-bt" placeholder="Surname" name="surname" required>
                                    </div>
                                    <div class="form-group">
                                        <input type="text" class="email-bt" placeholder="Telephone Number" name="telephoneNumber" required>
                                    </div>
                                    <div class="form-group">
