...
<body>
    ...
    <div class="container mt-5 mb-2">
        <div class="btn btn-warning goInLink" name="basket/finishBasket">Siparişler</div>
    </div>
        ...
        ?>
            <div class="table-responsive">
                ...
                <div class="d-flex flex-column flex-md-row justify-content-between mt-3">
                    ...
                    <button class="btn btn-success" id="checkout"><a href="<?= base_url("payment"); ?>">Ödeme Yap</a></button>
                </div>
